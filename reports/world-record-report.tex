...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{base_hero.png}
    \caption*{\small Shot 01: Hero (Flux 2 Dev)}
\end{minipage}\hfill
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{base_rain.png}
    \caption*{\small Shot 02: Rain}
\end{minipage}\hfill
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{base_night.png}
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{refined_hero.png}
...
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{composited_hero_9x16.png}
    \caption*{\small 9:16 Portrait}
\end{minipage}\hfill
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{composited_rain_1x1.png}
    \caption*{\small 1:1 Square}
\end{minipage}\hfill
\begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{composited_brutalist_16x9.png}
...
\begin{minipage}{0.19\textwidth}
    \centering
    \includegraphics[width=\textwidth]{riff_greenhouse.png}
    \caption*{\tiny Greenhouse}
\end{minipage}\hfill
\begin{minipage}{0.19\textwidth}
    \centering
    \includegraphics[width=\textwidth]{riff_neon_cityscape.png}
    \caption*{\tiny Neon Cityscape}
\end{minipage}\hfill
\begin{minipage}{0.19\textwidth}
    \centering
    \includegraphics[width=\textwidth]{riff_cherry_blossom.png}
    \caption*{\tiny Cherry Blossom}
\end{minipage}\hfill
\begin{minipage}{0.19\textwidth}
    \centering
    \includegraphics[width=\textwidth]{riff_mirror_room.png}
    \caption*{\tiny Mirror Room}
\end{minipage}\hfill
\begin{minipage}{0.19\textwidth}
    \centering
    \includegraphics[width=\textwidth]{riff_cathedral.png}
